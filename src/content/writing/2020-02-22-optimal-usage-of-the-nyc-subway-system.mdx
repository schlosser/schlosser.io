...
### When taking the 1 train to Christopher Street or transferring to the 7 at
Times Square, riders should choose in the middle car to cut down on wasted time.
...
<Image
  image={import("img/subway-local-train-periodicity.png")}
  className="tight"
/>
##### Tapping on the station in the transit overview in Google Maps displays
departure times. Here, the 1 train runs every 4-5 minutes.
...
<em>
  Does my math not add up? Shoot me a{" "}
  <a href="https://twitter.com/danrschlosser">tweet</a> or{" "}
  <a href="mailto:dan@schlosser.io">email</a> and let me know.
</em>
