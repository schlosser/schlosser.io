...
<ImageSet size="large">
    <Image image={import("img/pangea-home.png")} withViewer />
    <Image image={import("img/pangea-author.png")} withViewer />
    <Image image={import("img/pangea-talks.png")} withViewer />
    <Image image={import("img/pangea-faq.png")} withViewer />
</ImageSet>
...
<Image image={import("img/pangea.png")} withViewer />
<h5>The <code>pangea.js</code> logo, courtesy of <a href="https://jhil.co\">Jeff Hilnbrand</a>.</h5>
...
<div style="position: relative; padding-bottom: 59%; height: 0; overflow: hidden; max-width: 100%; height: auto;">
  <iframe
    style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"
    src="https://www.youtube.com/embed/TajUUbg_Q94"
    frameborder="0"
    allowfullscreen
  ></iframe>
</div>
