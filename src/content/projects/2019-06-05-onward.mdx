...
title: Onward
date: 2019-06-05
featuredImage: img/onward-logo.png
heroStyle: none
...
<ImageSet size="large" captions={["The Medium-inspired editor encourages users to write image-rich posts."]}>
    <Image image={import("img/onward-home.png")} withViewer />
    <Image image={import("img/onward-grid.png")} withViewer />
    <Image image={import("img/onward-hero.png")} withViewer />
    <Image image={import("img/onward-inline.png")} withViewer />
</ImageSet>
...
<Image image={import("img/onward-editor.gif")} withViewer caption="Dropping a hero image into a post is downright fun." />
...
<Image image={import("img/onward-city.gif")} withViewer caption="Don't you just NEED to go to Tokyo?" />
